...
CREATE TABLE `result` (
  ...
  CONSTRAINT `result_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`) ON DELETE CASCADE
...
--
-- Dumping events for database 'hvvp'
--

--
-- Dumping routines for database 'hvvp'
--
...
-- Dump completed on 2025-07-10 15:20:48
